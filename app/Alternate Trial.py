...
st.sidebar.markdown("Providing cutting-edge Data Science solutions for analytics and risk management in the oil and gas industry.")
...
# --- **NEW: Sidebar Visualization Customization** ---
...
selected_palette_heatmap = st.sidebar.selectbox(
    ...
    index=sequential_palettes.index('coolwarm') # Default to coolwarm
)
...
# --- Sidebar Company Description Pop-out ---
sidebar_info = """
    <div style="background-color: #f9f9f9; padding: 10px; border-radius: 5px; box-shadow: 2px 2px 5px #888888; margin-top: 15px; width: 90%;">
        <h6 style="color: #336699; margin-bottom: 5px;">IONARTS Projects Consult is a tech company registered as a limited liability firm with registration number 12536168. We are headquartered at 182 Hylton Road, Sunderland, SR4 7YA. Get in touch with us for your projects via the contact details above. We serve you best!</h6>
        <p style="font-size: 12px; line-height: 1.2;">IONARTS is dedicated to transforming data into actionable insights, empowering businesses in the oil and gas sector to make smarter, more informed decisions.</p>
    </div>
"""
    ...
    try:
        ...
        st.markdown(
            ...
            .stApp {{
                ...
                background-size: auto, auto; /* Adjust as needed, e.g., '20% auto' */
            }}
...
try:
    image_path = r"C:\Users\HP\Documents\DATASCIENCE PRODUCT FOR PREDICTIVE MAINTENANCE\Jupyter env\data\Pipes3.png"
    ...
    st.warning("Warning: Background image 'Pipes3.png' not found. Background will be default.")
except Exception as e:
...
if predict_button:
    ...
    if final_input.shape[1] == model.n_features_in_:
        ...
        else: st.success("✅ Machine is predicted to be operating normally.")
    else: st.error(f"Error: Input data shape mismatch.")

# --- ION Poduct for Batch Prediction Section ---
...
# --- Footer ---
st.markdown("---")
st.markdown("© Developed by IONARTS PROJECTS CONSULT- 2025")